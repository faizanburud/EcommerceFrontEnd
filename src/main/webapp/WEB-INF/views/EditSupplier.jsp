...
<body>
	...
	<!-- //breadcrumbs -->
	<c:set var="xyz" value="${pageContext.request.contextPath}"/>
	<div class="login-form-grids">
		<h6 class="animated wow slideInUp" data-wow-delay=".5s">SUPPLIER
			DETAILS</h6>
		<c:url var="addAction" value="/supplier"></c:url>
		<form:form action="${xyz}/addsup" commandName="supplier"
