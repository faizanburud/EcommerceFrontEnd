...
<body>
	...
	<div class="login-form-grids">
		...
		<form:form action="addprod" commandName="proddata" enctype="multipart/form-data"
			...
			<form:input path="Product_name" placeholder="ProductName" type="text" />
			<br>
			<form:input path="Product_price" placeholder="ProductPrice"
				type="text" />
			<br>
			<form:input path="image" placeholder="ProductImage"
				type="file" />
			<br>
			<form:input path="Product_description"
				placeholder="ProductDescription" type="text" />
